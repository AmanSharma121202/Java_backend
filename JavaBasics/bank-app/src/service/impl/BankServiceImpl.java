...
//        String accountNumber = UUID.randomUUID().toString();
    ...
    public void transfer(String fromAcc, String toAcc, Double amount, String note) {
        ...
        if(fromAcc.equals(toAcc)){
            throw new ValidationException("Cannot transfer to your account");
        }
        ...
        transactionRepository.add(new Transaction(from.getAccountNumber(), amount, UUID.randomUUID().toString(),note, LocalDateTime.now(), Type.DEBIT));
        transactionRepository.add(new Transaction(to.getAccountNumber(), amount, UUID.randomUUID().toString(),note, LocalDateTime.now(), Type.CREDIT));
    }
...
//        Method 2
    ...
    private String getAccountNumber() {
        ...
        return String.format("AC%06d", size); // Create account number in format "AC" then 6-digit number (Trailing zero + account size)
    }
